...
printf "jarsigner -sigalg SHA1withRSA -digestalg SHA1 -keystore $npm_package_config_javakeystore $npm_package_config_buildfolder/android/release-unsigned.apk $npm_package_config_javakeystorealiasname";
